    ...
    const chats = [
        {
            name: "John Doe",
            status: "online",
            img: "https://inst.eecs.berkeley.edu/~cs194-26/fa17/upload/files/proj4/cs194-26-adq/asianguy.jpg"
        },
        {
            name: 'Adam Smith',
            status: 'offline',
            img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8cmFuZG9tJTIwcGVyc29ufGVufDB8fDB8fHww"
        },
        {
            name: 'Jenny Craig',
            status: 'online',
            img: "https://preview.redd.it/tried-to-generate-a-random-face-with-ai-now-i-have-to-worry-v0-indsbidh39la1.jpg?width=640&crop=smart&auto=webp&s=9020f96f8079f3518c6617f97a6362b2fbeb744b"
        },

        {
            name: 'Michael Thomas',
            status: 'online',
            img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSykxfIcrh2AWL6lYLpQetr0zmKVlQ4sNsJDg&usqp=CAU"
        },
        {
            name: 'Ethan Hunt',
            status: 'offline',
